      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p className="text-xl text-gray-400">La gama de productos que integran REX 360 proveera de un abanico de herramientas para incrementar la productividad de su negocio.</p>
          </div>

          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <img className="max-w-full mx-auto md:max-w-none h-auto" src={Productos360} width="740" height="505" alt="Productos 360" />
          </div>
